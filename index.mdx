---
title: "ccccpay Open API Introduction"
description: "ccccpay is a secure and innovative payment solution for fiat currencies, designed to help merchants and businesses with multi-currency payment requirements quickly expand their global operations involving multiple fiat currencies. It provides a secure and convenient way to manage assets. "
---

## **Integration Setup**

To establish communication with the ccccpay system, you will need identity and authentication credentials.
